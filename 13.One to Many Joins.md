...
Here is a _CROSS JOIN_. It's a combination of every single customer with every single order (5 x 5, which is why we have 25 rows returned). This is not useful. This doesn't tell us anything, but it is something we can do and it is technically a join. What we're going to see in the next video is how we can make joints that help us.
