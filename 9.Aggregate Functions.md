...
This means the average year is closeto 2000.

---

We can also find the avearge number of pages across all books, such as:
...
To summmarise, functions such as `MIN`, `MAX`, `SUM`, `COUNT`, `AVERAGE` we can use them on entire tables or use them on groupsto find our more information about each of those groups.
...
4. Find the average released_year for each book. Uuse the first and last name when you are grouping.
...
5. Find the full name of rhe auhtor who wrote the longest book. For this use a subquery 
